...
from models.LSTM_en_de import Seq2seqBaseWithoutEmbw
from utils.evaluate_tools import acc_metrics, recall_metrics, f1_metrics
...
def trainer_base_no_embw(args=None):
    if args is None:
